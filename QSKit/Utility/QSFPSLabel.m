...
- (instancetype)initWithFrame:(CGRect)frame {
    CGRect newF = frame;
    newF.size = kFPSLabelSize;
    
    if (self = [super initWithFrame:newF]) {
...
- (void)tick:(CADisplayLink *)link {
    ...
    NSMutableAttributedString *text = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%d FPS", (int)roundf(fps)]];
